  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden space-y-3">
        ...
        <div className="flex gap-1.5 flex-1 overflow-x-auto pb-1 scrollbar-hide">
          {[
            ...
            <button
              ...
              className={cn(
                "px-3 py-1 rounded-full text-xs font-medium shrink-0 transition-colors active:scale-[0.98]",
      ...
      {isLoading ? (
        ...
        <TaskListView tasks={filtered} onUpdate={update} onDelete={del} onConfirm={onConfirm} />
      ) : (
        <TaskKanbanView tasks={tasks} onUpdate={update} onDelete={del} onConfirm={onConfirm} />
      )}
    </div>
  );
}
...
function TaskListView({ tasks, onUpdate, onDelete, onConfirm }: {
  tasks: any[];
  onUpdate: any;
  onDelete: any;
  ...
  if (tasks.length === 0) {
    return <div className="text-center py-12 text-muted-foreground text-sm">Aucune tâche pour le moment.<br/><span className="text-xs text-muted-foreground/60">Créez votre première tâche avec le bouton ci-dessus.</span></div>;
  }
  return (
      ...
      <PaginatedList items={tasks} initial={25} render={task => (
        ...
        >
          <button
            ...
            className="shrink-0 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
          >
            {task.status === "done"
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
...
function KanbanCard({ task, onMove, onDelete, onConfirm }: {
  task: any;
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <button
          ...
          className="p-1.5 rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center"
          aria-label="Supprimer la tâche"
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-[9px] text-muted-foreground hover:text-foreground bg-secondary px-1.5 py-0.5 rounded-full transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
  ...
  return (
    <div className="flex-1 overflow-y-auto space-y-3 min-h-0">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-muted-foreground text-sm">Aucun projet pour le moment.<br/><span className="text-xs text-muted-foreground/60">Créez votre premier projet avec le bouton ci-dessus.</span></div>
      ) : (
  ...
  return (
    <div className="flex-1 overflow-y-auto space-y-3 min-h-0">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-muted-foreground text-sm">Aucun contact pour le moment.<br/><span className="text-xs text-muted-foreground/60">Ajoutez votre premier contact avec le bouton ci-dessus.</span></div>
      ) : (
