...
export default function Overload() {
  ...
  return (
    <div className="p-8 md:p-12 max-w-5xl mx-auto space-y-12 min-h-screen">
      <header>
        <h1 className="text-3xl font-serif mb-2 text-foreground">Bien-être & Charge</h1>
        <p className="text-muted-foreground text-lg">L'objectif n'est pas de faire plus, mais de durer.</p>
      </header>
