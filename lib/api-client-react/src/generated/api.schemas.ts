...
export type TasksFromDecisionInputTasksItem = {
  title: string;
...
export type SystemExportData = { [key: string]: unknown };
...
export type RelationshipSuggestionEntityType = typeof RelationshipSuggestionEntityType[keyof typeof RelationshipSuggestionEntityType];


export const RelationshipSuggestionEntityType = {
  task: 'task',
  project: 'project',
  contact: 'contact',
  memory: 'memory',
...
export interface RelationshipSuggestion {
  entityType: RelationshipSuggestionEntityType;
  entityId: number;
  entityName: string;
  score: number;
  reason: string;
...
export type GetTaskSuggestions200 = {
  data?: RelationshipSuggestion[];
};

export type AutoLinkTask200 = {
  data?: RelationshipSuggestion[];
};

export type GetProjectRelated200 = {
  data?: ProjectRelated;
};

export type GetProjectSuggestions200 = {
  data?: RelationshipSuggestion[];
};

export type AutoLinkProject200 = {
  data?: RelationshipSuggestion[];
};

export type GetContactRelated200 = {
  data?: ContactRelated;
};

export type GetContactSuggestions200 = {
  data?: RelationshipSuggestion[];
};

export type AutoLinkContact200 = {
  data?: RelationshipSuggestion[];
};
