...
import type {
  ...
  GetContactRelated200,
  GetContactSuggestions200,
  GetProjectRelated200,
  GetProjectSuggestions200,
  GetRecentActivityParams,
  GetSystemAuditParams,
  GetTaskSuggestions200,
  HealthStatus,
  ListAssetsParams,
  ListContactsParams,
...
export const getGetTaskSuggestionsUrl = (id: number,) => {




  return `/api/tasks/${id}/suggestions`
}

/**
 * @summary Get relationship suggestions for a task
 */
export const getTaskSuggestions = async (id: number, options?: RequestInit): Promise<GetTaskSuggestions200> => {

  return customFetch<GetTaskSuggestions200>(getGetTaskSuggestionsUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetTaskSuggestionsQueryKey = (id: number,) => {
    return [
...
export const getGetTaskSuggestionsQueryOptions = <TData = Awaited<ReturnType<typeof getTaskSuggestions>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTaskSuggestions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTaskSuggestionsQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTaskSuggestions>>> = ({ signal }) => getTaskSuggestions(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTaskSuggestions>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetTaskSuggestions<TData = Awaited<ReturnType<typeof getTaskSuggestions>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTaskSuggestions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetTaskSuggestionsQueryOptions(id,options)
...
export const getAutoLinkTaskUrl = (id: number,) => {




  return `/api/tasks/${id}/auto-link`
}

/**
 * @summary Auto-link a task based on suggestions
 */
export const autoLinkTask = async (id: number, options?: RequestInit): Promise<AutoLinkTask200> => {

  return customFetch<AutoLinkTask200>(getAutoLinkTaskUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getAutoLinkTaskMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof autoLinkTask>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof autoLinkTask>>, TError,{id: number}, TContext> => {

const mutationKey = ['autoLinkTask'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof autoLinkTask>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  autoLinkTask(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AutoLinkTaskMutationResult = NonNullable<Awaited<ReturnType<typeof autoLinkTask>>>

    export type AutoLinkTaskMutationError = ErrorType<unknown>

    /**
 * @summary Auto-link a task based on suggestions
 */
export const useAutoLinkTask = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof autoLinkTask>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof autoLinkTask>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getAutoLinkTaskMutationOptions(options));
    }

export const getGetProjectRelatedUrl = (id: number,) => {




  return `/api/projects/${id}/related`
}

/**
 * @summary Get all entities related to a project
 */
export const getProjectRelated = async (id: number, options?: RequestInit): Promise<GetProjectRelated200> => {

  return customFetch<GetProjectRelated200>(getGetProjectRelatedUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetProjectRelatedQueryKey = (id: number,) => {
    return [
...
export const getGetProjectRelatedQueryOptions = <TData = Awaited<ReturnType<typeof getProjectRelated>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectRelated>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetProjectRelatedQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectRelated>>> = ({ signal }) => getProjectRelated(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectRelated>>, TError, TData> & { queryKey: QueryKey }
}

export type GetProjectRelatedQueryResult = NonNullable<Awaited<ReturnType<typeof getProjectRelated>>>
export type GetProjectRelatedQueryError = ErrorType<unknown>
...
export function useGetProjectRelated<TData = Awaited<ReturnType<typeof getProjectRelated>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectRelated>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetProjectRelatedQueryOptions(id,options)
 ...
 */
export const getProjectSuggestions = async (id: number, options?: RequestInit): Promise<GetProjectSuggestions200> => {

  return customFetch<GetProjectSuggestions200>(getGetProjectSuggestionsUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getAutoLinkProjectUrl = (id: number,) => {




  return `/api/projects/${id}/auto-link`
}

/**
 * @summary Auto-link a project based on suggestions
 */
export const autoLinkProject = async (id: number, options?: RequestInit): Promise<AutoLinkProject200> => {

  return customFetch<AutoLinkProject200>(getAutoLinkProjectUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getAutoLinkProjectMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof autoLinkProject>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof autoLinkProject>>, TError,{id: number}, TContext> => {

const mutationKey = ['autoLinkProject'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof autoLinkProject>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  autoLinkProject(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AutoLinkProjectMutationResult = NonNullable<Awaited<ReturnType<typeof autoLinkProject>>>

    export type AutoLinkProjectMutationError = ErrorType<unknown>

    /**
 * @summary Auto-link a project based on suggestions
 */
export const useAutoLinkProject = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof autoLinkProject>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof autoLinkProject>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getAutoLinkProjectMutationOptions(options));
    }

export const getGetContactRelatedUrl = (id: number,) => {




  return `/api/contacts/${id}/related`
}

/**
 * @summary Get all entities related to a contact
 */
export const getContactRelated = async (id: number, options?: RequestInit): Promise<GetContactRelated200> => {

  return customFetch<GetContactRelated200>(getGetContactRelatedUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetContactRelatedQueryKey = (id: number,) => {
    return [
...
export const getGetContactRelatedQueryOptions = <TData = Awaited<ReturnType<typeof getContactRelated>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getContactRelated>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetContactRelatedQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getContactRelated>>> = ({ signal }) => getContactRelated(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getContactRelated>>, TError, TData> & { queryKey: QueryKey }
}

export type GetContactRelatedQueryResult = NonNullable<Awaited<ReturnType<typeof getContactRelated>>>
export type GetContactRelatedQueryError = ErrorType<unknown>
...
export function useGetContactRelated<TData = Awaited<ReturnType<typeof getContactRelated>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getContactRelated>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetContactRelatedQueryOptions(id,options)
...
export const getGetContactSuggestionsUrl = (id: number,) => {




  return `/api/contacts/${id}/suggestions`
}

/**
 * @summary Get relationship suggestions for a contact
 */
export const getContactSuggestions = async (id: number, options?: RequestInit): Promise<GetContactSuggestions200> => {

  return customFetch<GetContactSuggestions200>(getGetContactSuggestionsUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetContactSuggestionsQueryKey = (id: number,) => {
    return [
    `/api/contacts/${id}/suggestions`
    ] as const;
    }


export const getGetContactSuggestionsQueryOptions = <TData = Awaited<ReturnType<typeof getContactSuggestions>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getContactSuggestions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetContactSuggestionsQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getContactSuggestions>>> = ({ signal }) => getContactSuggestions(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getContactSuggestions>>, TError, TData> & { queryKey: QueryKey }
}

export type GetContactSuggestionsQueryResult = NonNullable<Awaited<ReturnType<typeof getContactSuggestions>>>
export type GetContactSuggestionsQueryError = ErrorType<unknown>
...
export function useGetContactSuggestions<TData = Awaited<ReturnType<typeof getContactSuggestions>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getContactSuggestions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetContactSuggestionsQueryOptions(id,options)
...
export const getAutoLinkContactUrl = (id: number,) => {




  return `/api/contacts/${id}/auto-link`
}

/**
 * @summary Auto-link a contact based on suggestions
 */
export const autoLinkContact = async (id: number, options?: RequestInit): Promise<AutoLinkContact200> => {

  return customFetch<AutoLinkContact200>(getAutoLinkContactUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getAutoLinkContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof autoLinkContact>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof autoLinkContact>>, TError,{id: number}, TContext> => {

const mutationKey = ['autoLinkContact'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof autoLinkContact>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  autoLinkContact(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AutoLinkContactMutationResult = NonNullable<Awaited<ReturnType<typeof autoLinkContact>>>

    export type AutoLinkContactMutationError = ErrorType<unknown>

    /**
 * @summary Auto-link a contact based on suggestions
 */
export const useAutoLinkContact = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof autoLinkContact>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof autoLinkContact>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getAutoLinkContactMutationOptions(options));
    }
